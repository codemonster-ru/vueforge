...
| Class | Description |
| --- | --- |
| `.vf-avatar` | Root element. |
| `.vf-avatar--sm` | Small size. |
| `.vf-avatar--lg` | Large size. |
| `.vf-avatar--circle` | Circular shape. |
...
| `avatarFontSizeLg` | `--vf-avatar-font-size-lg` | `20px` font size for `lg` label and icon avatars. |
