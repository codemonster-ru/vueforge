---
title: "Components"
description: "Component catalog for the core package"
order: 4
---

# Components

Core component docs are intentionally lightweight: each page includes key props, emits/slots, and an interactive snippet.

- [Button](./button/index.md)
- [Alert](./alert/index.md)
- [Input](./input/index.md)
- [Badge](./badge/index.md)
...
- [Breadcrumbs](./breadcrumbs/index.md)
...
- [Divider](./divider/index.md)
- [Table](./table/index.md)
- [Icon Button](./icon-button/index.md)
- [Menu Bar](./menu-bar/index.md)
- [Tabs](./tabs/index.md)
- [Nav Menu](./nav-menu/index.md)
- [Panel](./panel/index.md)
- [Switch](./switch/index.md)
- [Table Of Contents](./table-of-contents/index.md)
- [Theme Switch](./theme-switch/index.md)
- [Tag](./tag/index.md)
