...
| `disabled?`        | `boolean`                                | `false`        | Prevents pointer and keyboard opening.                                         |
...
| Name      | Parameters                                                          | ReturnType | Description                                 |
| --------- | ------------------------------------------------------------------- | ---------- | ------------------------------------------- |
| `trigger` | `[scope: { open: boolean; toggle: () => void; disabled: boolean }]` | `void`     | trigger node (`{ open, toggle, disabled }`) |
