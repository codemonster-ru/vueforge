...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Field label typography         | `--vf-field-label-font-size`, `--vf-text-label-font-weight`, `--vf-text-label-line-height`                                                                                            | Label font size, weight, and line height.                                             |
...
| Helper text color              | `--vf-color-text-muted`                                                                                                                                                               | Neutral helper text tone.                                                             |
| Error text color               | `--vf-color-status-danger-solid-background`                                                                                                                                           | Error text tone.                                                                      |
