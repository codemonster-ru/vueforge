...
| Select states | `--vf-select-hover-border-color`, `--vf-select-focus-border-color`, `--vf-select-invalid-border-color` | Border colors for hover, focus, and invalid states. |
