...
| Chart                 | Both           | Yes         | Yes          |
| AreaChart             | Both           | Yes         | Yes          |
| BarChart              | Both           | Yes         | Yes          |
| LineChart             | Both           | Yes         | Yes          |
| PieChart              | Both           | Yes         | Yes          |
| DonutChart            | Both           | Yes         | Yes          |
| ScatterChart          | Both           | Yes         | Yes          |
| BubbleChart           | Both           | Yes         | Yes          |
| Histogram             | Both           | Yes         | Yes          |
| Heatmap               | Both           | Yes         | Yes          |
| RadarChart            | Both           | Yes         | Yes          |
| FunnelChart           | Both           | Yes         | Yes          |
| TreemapChart          | Both           | Yes         | Yes          |
| GaugeChart            | Both           | Yes         | Yes          |
| CandlestickChart      | Both           | Yes         | Yes          |
| Sparkline             | Both           | Yes         | Yes          |
| Image                 | Both           | Yes         | Yes          |
