...
Gate columns include `Responsive` to enforce mobile/tablet/desktop behavior planning before implementation starts.

| Component             | Target Catalog | Implementation | DoD     | Tests   | A11y    | SSR/Hydration | Responsive | Visual  | Docs    | Catalog |
| --------------------- | -------------- | -------------- | ------- | ------- | ------- | ------------- | ---------- | ------- | ------- | ------- |
| ActivityFeed          | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| AdvancedFilterPanel   | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| AuditLogViewer        | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
...
| BlockUI               | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
...
| Fieldset              | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| FileManager           | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| FloatLabel            | PrimeVue       | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| Galleria              | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| Hotkey                | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| Hover                 | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
...
| InputIcon             | PrimeVue       | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| JSONViewer            | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
...
| PickList              | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| QueryBuilder          | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| SavedViewsManager     | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| Scheduler             | Vuetify        | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| ScrollPanel           | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
| ScrollTop             | Both           | Planned        | Planned | Planned | Planned | Planned       | Planned    | Planned | Planned | Yes     |
...
- When implementation starts, set `Implementation` to `In Progress` in this file.
- When a component is released, move it to `docs/audits/component-compliance-matrix.md` and set all completed gates there.
- Keep this file and `docs/audits/component-catalog-mapping.md` synchronized in the same PR.
- A component cannot transition to `Done`/released status while any compliance gate is not `Done` (or explicit justified `N/A`).
