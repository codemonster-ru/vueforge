...
Playground ownership follows
[CodeMonster UI Playground ownership](./architecture/playground-ownership.md).
...
- [x] `CMUI-143` Migrate the advanced-input cohort: Select, DatePicker, and CommandPalette.
...
- [x] `CMUI-148` Decide and implement Playground ownership.
...
- [x] `CMUI-149` Freeze the final VueForge feature baseline.
- [x] `CMUI-150` Publish the VueForge-to-CodeMonster UI package mapping.
- [x] `CMUI-151` Add a read-only migration checker.
- [x] `CMUI-152` Add deterministic codemods for approved renames.
- [x] `CMUI-153` Migrate the repository examples to CodeMonster UI.
