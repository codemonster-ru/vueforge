...
- Performance budgets: [`docs/audits/performance-budgets.md`](docs/audits/performance-budgets.md)
- Performance benchmarks: [`docs/audits/performance-benchmarks.md`](docs/audits/performance-benchmarks.md)
- Performance guidance and limits: [`docs/guides/performance-guidance-limits.md`](docs/guides/performance-guidance-limits.md)
- Live playground recipe: [`docs/recipes/live-playground.md`](docs/recipes/live-playground.md)
