...
export type CodeBlockTokens = {
    ...
    darkBackgroundColor?: string;
    darkTextColor?: string;
    darkHeaderBorderColor?: string;
    darkMetaColor?: string;
    darkFilenameColor?: string;
    darkActionBorderColor?: string;
    darkActionBackgroundColor?: string;
    darkActionTextColor?: string;
    darkLineNumberColor?: string;
    tokenKeywordColor?: string;
    tokenStringColor?: string;
    tokenNumberColor?: string;
    tokenCommentColor?: string;
    tokenVariableColor?: string;
    tokenTagColor?: string;
    tokenSelectorColor?: string;
    tokenComponentColor?: string;
    tokenAttributeColor?: string;
    tokenDirectiveColor?: string;
    tokenIdentifierColor?: string;
    tokenFunctionColor?: string;
    tokenPropertyColor?: string;
    tokenOperatorColor?: string;
    darkTokenKeywordColor?: string;
    darkTokenStringColor?: string;
    darkTokenNumberColor?: string;
    darkTokenCommentColor?: string;
    darkTokenVariableColor?: string;
    darkTokenTagColor?: string;
    darkTokenSelectorColor?: string;
    darkTokenComponentColor?: string;
    darkTokenAttributeColor?: string;
    darkTokenDirectiveColor?: string;
    darkTokenIdentifierColor?: string;
    darkTokenFunctionColor?: string;
    darkTokenPropertyColor?: string;
    darkTokenOperatorColor?: string;
    disabledOpacity?: string;
};
