...
Coordinated release: `@codemonster-ru/vueforge-core@2.4.0`.
...
[installation guide](https://github.com/codemonster-ru/ui/blob/main/docs/core/installation.md)
and [CHANGELOG.md](https://github.com/codemonster-ru/ui/blob/main/packages/core/CHANGELOG.md).

## License

[MIT](https://github.com/codemonster-ru/ui/blob/main/packages/core/LICENSE)
