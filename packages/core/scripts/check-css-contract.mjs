...
const ownBases = {
  ...
  'confirm-dialog.css': ['confirm-dialog'],
  'data-table.css': ['data-table', 'data-table-wrap', 'data-table-scroll'],
  'data-table-column-chooser.css': ['data-table-column-chooser'],
  ...
  'form-layout.css': ['form-layout'],
  'group-box.css': ['group-box', 'icon'],
...
const explicitDeps = {
  ...
  'confirm-dialog.css': ['./button.css', './dialog.css'],
  'data-table.css': ['./table.css', './icon-button.css', './progress-spinner.css', './select.css', './skeleton.css'],
  'data-table-column-chooser.css': ['./checkbox.css', './dropdown.css', './icon-button.css'],
  ...
  'group-box.css': ['./button.css'],
  'form-layout.css': ['./field.css'],
  'input.css': ['./field.css', './icon-button.css'],
  'page-header.css': ['./breadcrumbs.css'],
