...
export default defineConfig(({ mode }) => {
  ...
  const buildEntries: Record<string, string> = isCjsBuild
    ...
    : {
        ...
        'confirm-dialog': resolve(__dirname, 'src/entries/confirm-dialog.ts'),
        'data-table': resolve(__dirname, 'src/entries/data-table.ts'),
        'data-table-column-chooser': resolve(__dirname, 'src/entries/data-table-column-chooser.ts'),
        ...
        'form-layout': resolve(__dirname, 'src/entries/form-layout.ts'),
        'group-box': resolve(__dirname, 'src/entries/group-box.ts'),
        ...
        'page-header': resolve(__dirname, 'src/entries/page-header.ts'),
