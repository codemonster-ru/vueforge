export default {
    ...
    timesWidth: '8rem',
    timesMaxHeight: '13rem',
    timesPaddingLeft: '0.5rem',
    timesBorderColor: 'var(--vf-border-color)',
    timeOptionPadding: '0.4rem 0.5rem',
    timeOptionBorderRadius: 'var(--vf-radii-sm)',
    timeOptionFontSize: '0.875rem',
    timeOptionHoverBackgroundColor: 'rgba(var(--vf-blue-600-rgb), 0.08)',
    timeOptionActiveBackgroundColor: 'rgba(var(--vf-blue-600-rgb), 0.14)',
    timeOptionActiveTextColor: 'var(--vf-text-color)',
    small: {
