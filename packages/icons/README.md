...
See
[src/lib/index.ts](https://github.com/codemonster-ru/ui/blob/main/packages/icons/src/lib/index.ts)
and [CHANGELOG.md](https://github.com/codemonster-ru/ui/blob/main/packages/icons/CHANGELOG.md)
for the package-local public contract and release history.

## License

[MIT](https://github.com/codemonster-ru/ui/blob/main/packages/icons/LICENSE)
