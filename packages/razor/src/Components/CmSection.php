...
final readonly class CmSection implements ComponentInterface
{
    ...
    public function render(ComponentRenderContext $context): RenderedHtml
    {
        ...
        $element = $props->oneOf('element', ['section', 'div', 'article', 'aside'], 'section');
        $surface = $props->bool('surface');
        $attributes = new AttributeBag($props->remaining());
        $classes = (new ClassBuilder())->add('cm-section')->addWhen($surface, 'cm-section--surface')
