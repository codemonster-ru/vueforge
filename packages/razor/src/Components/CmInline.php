...
final readonly class CmInline implements ComponentInterface
{
    ...
    public function render(ComponentRenderContext $context): RenderedHtml
    {
        ...
        $element = $props->oneOf('element', ['div', 'nav', 'ul'], 'div');
        $wrap = $props->bool('wrap', true);
        $attributes = new AttributeBag($props->remaining());
        $classes = (new ClassBuilder())->add('cm-inline')->addWhen(!$wrap, 'cm-inline--nowrap')
