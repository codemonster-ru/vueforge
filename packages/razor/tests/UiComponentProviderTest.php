...
final class UiComponentProviderTest extends TestCase
{
    public function testRegistersTheCodeMonsterPrefix(): void
    {
        ...
        self::assertInstanceOf(CmContainer::class, $provider->components()['container']);
        ...
        self::assertInstanceOf(CmFieldset::class, $provider->components()['fieldset']);
        self::assertInstanceOf(CmGrid::class, $provider->components()['grid']);
        self::assertInstanceOf(CmIconButton::class, $provider->components()['icon-button']);
        self::assertInstanceOf(CmInput::class, $provider->components()['input']);
        self::assertInstanceOf(CmInline::class, $provider->components()['inline']);
        ...
        self::assertInstanceOf(CmProgressBar::class, $provider->components()['progress-bar']);
        self::assertInstanceOf(CmProgressSpinner::class, $provider->components()['progress-spinner']);
        ...
        self::assertInstanceOf(CmSection::class, $provider->components()['section']);
        self::assertInstanceOf(CmStack::class, $provider->components()['stack']);
        ...
        self::assertInstanceOf(CmContainer::class, $registry->resolve('cm-container'));
        ...
        self::assertInstanceOf(CmFieldset::class, $registry->resolve('cm-fieldset'));
        self::assertInstanceOf(CmGrid::class, $registry->resolve('cm-grid'));
        self::assertInstanceOf(CmIconButton::class, $registry->resolve('cm-icon-button'));
        self::assertInstanceOf(CmInput::class, $registry->resolve('cm-input'));
        self::assertInstanceOf(CmInline::class, $registry->resolve('cm-inline'));
        ...
        self::assertInstanceOf(CmProgressBar::class, $registry->resolve('cm-progress-bar'));
        self::assertInstanceOf(CmProgressSpinner::class, $registry->resolve('cm-progress-spinner'));
        ...
        self::assertInstanceOf(CmSection::class, $registry->resolve('cm-section'));
        self::assertInstanceOf(CmStack::class, $registry->resolve('cm-stack'));
