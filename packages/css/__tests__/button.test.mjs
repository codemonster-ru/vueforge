...
test('styles canonical Button state and content hooks', () => {
  ...
  assert.match(css, /background: color-mix\(in srgb, currentcolor 30%, transparent\);/);
  assert.match(css, /viewBox='0 0 50 50'/);
  assert.match(css, /r='20'/);
  assert.match(css, /stroke-width='5'/);
