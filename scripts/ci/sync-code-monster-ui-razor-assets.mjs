...
const sources = [
  ...
  { packageDirectory: 'css', path: 'components/fieldset.css', export: './fieldset.css' },
  { packageDirectory: 'css', path: 'components/grid.css', export: './grid.css' },
  { packageDirectory: 'css', path: 'components/icon-button.css', export: './icon-button.css' },
